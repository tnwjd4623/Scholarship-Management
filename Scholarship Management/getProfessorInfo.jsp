...
<%			}
		...
		<div class="grid">
			...
			<div class="h2_wrap">
				<h2>학번: <%=professor_id %></h2>
			</div>
				
			<form class="form login" method="get" action="modifyProfessorInfo.jsp">
				<input  type="hidden" name="id" value="<%=professor_id %>">
				<input type="hidden" name="name" value="<%=name %>">
				
				<div class="form__field">
					<h3>비밀번호&nbsp</h3>
					<input class="form__input" type="password" name="pw" maxlength="20" placeholder=""><br/><br/>
				</div>
				
				<div class="form__field">
					<h3>주소&nbsp</h3>
					<input class="form__input" type="text" name="address" value="<%=address %>" required><br/><br/>
				</div>
