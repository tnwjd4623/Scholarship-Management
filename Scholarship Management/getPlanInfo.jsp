...
<%		
	...
	%>			<header>
				...
				<div class="grid">
					<form class="form login" method="post" action="./getPlanInfo_action.jsp">
						<div class="form__field">
							<h3>과목명</h3><input class="form__input" type="text" name="name" maxlength="20" required placeholder="Subject name">	
						</div>
