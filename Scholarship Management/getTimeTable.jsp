				...
				try {
					...
					try{
						...
						while(rs3.next()) {	
							...
							String sql = "select classroom, time, day from subject where number=?";
							pstmt = conn.prepareStatement(sql);
							...
							if(count%2==0) {
								%> <tr>
									...
									<td class="even"><%=rs.getString("classroom")%>
									<td class="even"><%=rs.getString("time")%>
