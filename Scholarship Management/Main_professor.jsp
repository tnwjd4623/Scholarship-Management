	...
	%>			<header>
				...
				<section class="tile_section">
					<div class="tile">
						...
						<button class="raise" onClick="location.href='./getProfessorInfo.jsp'">바로가기 ☞</button>
					</div>
					<div class="tile">
						...
						<span class="menu">과목개설</span><br/>
						<button class="raise" onClick="location.href='./registerSubject.jsp'">바로가기 ☞ </button>
					</div>
					<div class="tile">
						<div class="img_container">
							<img src="./grade.png"></img>
						</div>
						<span class="menu">성적등록</span><br/>
						<button class="raise" onClick="location.href='./registerGrade.jsp'">바로가기 ☞ </button>
					</div>
					<br/>
					<div class="tile">
						...
						<span class="menu">강의계획서 등록</span><br/>
						<button class="raise" onClick="location.href='./registerPlanInfo.jsp'">바로가기 ☞ </button>
					</div>
					<div class="tile">
					...
					<div class="tile">
						...
						<button class="raise" onClick="location.href='./getTimeTable_pro.jsp'">바로가기 ☞</button>
					</div>
				</section>
